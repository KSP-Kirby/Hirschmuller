% This script get's the extrinsic paramters for the image that is loaded
% into I1.
...
camMatrix = cameraMatrix(stereoParams.CameraParameters1,rotationMatrix,translationVector);
